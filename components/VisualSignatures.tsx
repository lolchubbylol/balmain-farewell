...
const VisualSignatures: React.FC = () => {
  ...
  const students = [
    ...
    },
    {
      ...
      funFact: "The only female USYD nursing student Class of 2025 doing 1330-2100hrs shifts at Lever Ward, Balmain Hospital 33.8568°S, 151.1784°E. She keeps the boys in check 💪"
    },
    {
      name: "Sonny",
